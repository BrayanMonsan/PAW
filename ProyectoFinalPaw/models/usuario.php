<?php
    class Usuario{
        ...
        public function CrearUsuario ($Nombre, $Correo, $Clave, $Telefono, $Municipio, $Colonia, $CodigoPostal){
            try{
                include'conexion.php';
                $conecta=new Conectar();
                $consulta= $conecta->prepare("INSERT INTO Usuarios(Nombre,Correo,Clave,Telefono,Municipio,Colonia,CodigoPostal)
                VALUES(:Nombre, :Correo, :Clave, :Telefono, :Municipio, :Colonia, :CodigoPostal)");
